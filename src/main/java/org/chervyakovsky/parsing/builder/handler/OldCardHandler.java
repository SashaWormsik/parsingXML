            ...
            switch (currentXmlTag) {
                case IMAGE_THEME:
                    try {
                        ...
                        LOGGER.warn(exception); // FIXME
                    }
                    break;
                case FIRST_NAME:
                    Author tempAuthor = currentOldCard.getAuthor();
                    tempAuthor.setFirstName(data);
                    currentOldCard.setAuthor(tempAuthor);
                    break;
                case LAST_NAME:
                    tempAuthor = currentOldCard.getAuthor();
                    tempAuthor.setLastName(data);
                    currentOldCard.setAuthor(tempAuthor);
                    break;
                case COUNTRY:
                    try {
