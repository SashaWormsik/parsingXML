...
import org.chervyakovsky.parsing.entity.*;
...
public class OldCardStaxBuilder extends AbstractOldCardBuilder {
    ...
    public void buildSetOldCards(String xmlName, String xsdName) throws ParseXMLException {
        ...
        if (validatorSAX.isMatchesScheme(xmlLocation, xsdLocation)) {
            String name;
            try (FileInputStream inputStream = new FileInputStream(new File(xmlLocation))) {
    ...
    private void buildOldCard(XMLStreamReader reader, OldCardAbstract oldCardAbstract) throws XMLStreamException, ParseXMLException {
        ...
        throw new ParseXMLException("Unknown element");
    }
